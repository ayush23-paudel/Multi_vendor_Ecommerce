...
import { HomeIcon, LayoutListIcon, SquarePenIcon, SquarePlusIcon, MessageCircleIcon } from "lucide-react"
...
const StoreSidebar = ({storeInfo}) => {
    ...
    const sidebarLinks = [
        ...
        { name: 'Questions', href: '/store/manage-questions', icon: MessageCircleIcon },
